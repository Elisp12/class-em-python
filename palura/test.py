from palura.avaliacao import Avaliacao
from palura.item_cardapio.item_cardapio import ItemCardapio

class Restaurante:      # Classe mãe / pai
    restaurantes = []  # armazena
